...
// лимит неверных попыток ввода одного кода
const MAX_VERIFY_ATTEMPTS = 5;
// на сколько блокируем повторные попытки после исчерпания лимита
// (пока пользователь не запросит новый код — новый requestOtp сбрасывает счётчик)
const VERIFY_LOCK_SECONDS = 10 * 60;

// лимиты на ЗАПРОС кода (защита от спама SMS / подбора номеров)
...
/**
 * проверка лимита на ЗАПРОС кода (до генерации/отправки).
